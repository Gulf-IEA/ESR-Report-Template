...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, opacityback=0, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, leftrule=.75mm, breakable, rightrule=.15mm, colback=white, left=2mm, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Editing this template page}, opacitybacktitle=0.6, arc=.35mm, coltitle=black, bottomrule=.15mm]
